      ...
      <DashboardLayout>
        <div className="rounded-3xl bg-gradient-to-r from-[#04122D] to-[#0D2A5E] p-6 text-white shadow-lg md:p-8">
          ...
          <p className="mt-3 max-w-2xl text-gray-300">
            Learn how decentralized finance works, how people earn through
            staking and liquidity, and why risk management must come before
            rewards.
          </p>
        ...
        <div className="mt-6 rounded-2xl bg-white p-6 text-[#071A3D] shadow-lg">
          ...
          <p className="mt-4 leading-8 text-gray-700">
            ...
            module, you will learn how DeFi works, how staking and lending
            operate, why liquidity matters, and why every reward must be measured
            against risk.
          </p>
        </div>
