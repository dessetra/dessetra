...
export default function FinalAssessmentPage() {
  const assessmentPath = path.join(
    process.cwd(),
    "src/content/free/stage-4-evaluating-opportunities/module-4-final-assessment/assessment.json"
  );

  const rewardPath = path.join(
    process.cwd(),
    "src/content/free/stage-4-evaluating-opportunities/module-4-final-assessment/reward.json"
  );
    ...
    <DashboardLayout>
      <div className="rounded-3xl bg-gradient-to-r from-[#04122D] to-[#0D2A5E] p-6 text-white shadow-lg md:p-8">
        ...
        <h1 className="mt-3 text-3xl font-bold md:text-4xl">
          Evaluating Web3 Opportunities Final Assessment
        </h1>

        <p className="mt-3 max-w-2xl text-gray-300">
          Pass this assessment to earn your Analyst Badge and 100 DP.
        </p>
      </div>
