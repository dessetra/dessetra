    ...
    <DashboardLayout>
      ...
      <div className="mt-6 rounded-2xl bg-white p-6 text-[#071A3D] shadow-lg">
        ...
        <p className="mt-4 leading-8 text-gray-700">
          Every day, new projects compete for attention. Some create real value.
          Others survive on hype alone. In this module, you will learn how to
          evaluate opportunities intelligently by analyzing products,
