...
export default function FinalAssessmentPage() {
  const assessmentPath = path.join(
    process.cwd(),
    "src/content/free/stage-5-long-term-web3-success/module-5-final-assessment/assessment.json"
  );

  const rewardPath = path.join(
    process.cwd(),
    "src/content/free/stage-5-long-term-web3-success/module-5-final-assessment/reward.json"
  );
    ...
    <DashboardLayout>
      <div className="rounded-3xl bg-gradient-to-r from-[#04122D] to-[#0D2A5E] p-6 text-white shadow-lg md:p-8">
        ...
        <h1 className="mt-3 text-3xl font-bold md:text-4xl">
          Long-Term Web3 Success Final Assessment
        </h1>

        <p className="mt-3 max-w-2xl text-gray-300">
          Pass this assessment to earn your Master Navigator Badge and
          receive +100 DP.
        </p>
      </div>
