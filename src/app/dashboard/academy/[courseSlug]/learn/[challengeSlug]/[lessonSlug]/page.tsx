          ...
          <>
            ...
            {lessonContent?.content ? (
              <section className="mt-6 rounded-3xl bg-white p-6 text-[#071A3D] shadow-xl md:p-8">
                ...
                <div className="prose prose-slate mt-6 max-w-none prose-headings:scroll-mt-24 prose-headings:text-[#071A3D] prose-h1:mb-10 prose-h1:mt-4 prose-h1:text-center prose-h1:text-3xl prose-h1:font-extrabold md:prose-h1:text-4xl prose-h2:mb-6 prose-h2:mt-14 prose-h2:text-center prose-h2:text-2xl prose-h2:font-bold md:prose-h2:text-3xl prose-h3:mb-4 prose-h3:mt-10 prose-h3:text-center prose-h3:text-xl prose-h3:font-semibold md:prose-h3:text-2xl prose-p:my-5 prose-p:text-left prose-p:leading-8 prose-ul:my-5 prose-ol:my-5 prose-li:my-2 prose-li:text-left prose-li:leading-8 prose-strong:text-[#071A3D] prose-a:text-[#1E88E5] prose-hr:my-10 prose-blockquote:my-8 prose-blockquote:rounded-xl prose-blockquote:border-l-4 prose-blockquote:border-[#D4AF37] prose-blockquote:bg-[#D4AF37]/10 prose-blockquote:px-5 prose-blockquote:py-3 prose-blockquote:not-italic prose-table:my-8 prose-img:mx-auto prose-img:my-10 prose-img:w-full prose-img:max-w-4xl prose-img:rounded-2xl prose-img:border prose-img:border-gray-200 prose-img:shadow-xl">
